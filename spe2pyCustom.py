...
class SpeFile:
    ...
    def _get_wavelength(self):
        ...
        try:
            ...
            return
        # except:
        #     print('Wavelength stuff messeed up')
        #     return
    ...
    def image(self, frame=0, roi=0):
        ...
        """
        img = plt.imshow(self.data[frame][roi], cmap=cm.get_cmap('plasma'))
...
def imgobject(speobject, frame=0, roi=0):
    ...
    """
    img = plt.imshow(getattr(speobject, 'data')[frame][roi], cmap=cm.get_cmap('plasma'))
    return img
